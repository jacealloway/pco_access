...
if __name__ == "__main__": 
    ...
    try:
        ...
        logging.error(f"fetchError extracting check-in data for DF_CHECKINS: {e}")
    ...
    try:
        ...
        logging.error(f"fetchError extracting people activity data for DF_PEOPLE_ACTIVITY: {e}")
