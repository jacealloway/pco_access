...
GROUPS_writepath = r'/Users/jacealloway/Desktop/python/pco_access/analyzed/'
...
class PlanningCenterDataExporter:
    ...
    def get_sunday_of_week(self, meet_date_str: str) -> str:
        ...
        try:
            ...
            sunday_date = dt + datetime.timedelta(days=days_to_add)
                ...
                for event in events:
                    ...
                    for attendance in attendances:
                        ...
                        writer.writerow({
                            ...
                            "group meet date": group_meet_date,
                            "week-end sunday date": sunday_date,
                            "member first_name": member_first,
                            "member last_name": member_last,
                            "member role": member_role,
                            "attend status": attend_status,
                            "leader first_name": leader_first,
                            "leader last_name": leader_last
                        })

        print(f"Data exported successfully to {output_file} on {datetime.date.today()}")

if __name__ == "__main__":
    exporter = CombinedExporter(api_app_id=API_APP_ID, api_secret=API_SECRET)
    exporter.export_to_csv(GROUPS_writepath+"groups.csv")